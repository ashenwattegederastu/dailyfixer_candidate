                            ...
                            <%@ page import="java.util.LinkedHashSet" %>
                                ...
                                <%! // Helper method to convert color name to hex code private String
                                    ...
                                    <% User currentUser=(User) session.getAttribute("currentUser"); boolean
                                        ...
                                        currentUser !=null; Product product=(Product) request.getAttribute("product");
                                        List<ProductVariant> variants = (List<ProductVariant>)
                                            request.getAttribute("variants");
                                            boolean hasVariants =
                                            Boolean.TRUE.equals(request.getAttribute("hasVariants"));
                                            boolean outOfStock =
                                            Boolean.TRUE.equals(request.getAttribute("outOfStock"));
                                            Set<String> colors = (Set<String>) request.getAttribute("colors");
                                                    Set<String> sizes = (Set<String>) request.getAttribute("sizes");
                                                            Set<String> powers = (Set<String>)
                                                                    request.getAttribute("powers");
                                                                    Discount activeDiscount = (Discount)
                                                                    request.getAttribute("activeDiscount");
                                                                    Number displayPriceNum = (Number)
                                                                    request.getAttribute("displayPrice");
                                                                    Number originalPriceNum = (Number)
                                                                    request.getAttribute("originalPrice");
                                                                    double displayPrice = displayPriceNum != null ?
                                                                    displayPriceNum.doubleValue() : 0.0;
                                                                    double originalPrice = originalPriceNum != null ?
                                                                    originalPriceNum.doubleValue() : 0.0;
                                                                    String loginUrl = (String)
                                                                    request.getAttribute("loginUrl");
                                                                    boolean canPurchase =
                                                                    Boolean.TRUE.equals(request.getAttribute("canPurchase"));
                                                                    String purchaseLockMessage = (String)
                                                                    request.getAttribute("purchaseLockMessage");
                                                                    Number currentCartTotalNum = (Number)
                                                                    request.getAttribute("currentCartTotal");
                                                                    Number purchaseLimitNum = (Number)
                                                                    request.getAttribute("purchaseLimit");
                                                                    String variantDataJson = (String)
                                                                    request.getAttribute("variantDataJson");
                                                                    String baseDiscountJson = (String)
                                                                    request.getAttribute("baseDiscountJson");
                                                                    double currentCartTotal = currentCartTotalNum !=
                                                                    null ? currentCartTotalNum.doubleValue() : 0.0;
                                                                    double purchaseLimit = purchaseLimitNum != null ?
                                                                    purchaseLimitNum.doubleValue() : 10000.0;
                                                                    Store store = (Store) request.getAttribute("store");
                                                                    String storePhone = (String)
                                                                    request.getAttribute("storePhone");
                                                                    ...
                                                                    if (colors == null) colors = new LinkedHashSet<>();
                                                                        if (sizes == null) sizes = new LinkedHashSet<>
                                                                            ();
                                                                            if (powers == null) powers = new
                                                                            LinkedHashSet<>();
                                                                                if (variantDataJson == null ||
                                                                                variantDataJson.isEmpty())
                                                                                variantDataJson = "[]";
                                                                                if (baseDiscountJson == null ||
                                                                                baseDiscountJson.isEmpty())
                                                                                baseDiscountJson = "null";

                                                                                if (loginUrl == null) {
                                                                                loginUrl = request.getContextPath() +
                                                                                "/pages/authentication/login.jsp";
                                                                                }
                                                                                ...
                                                                                <% return; } %>
                                                                                    ...
                                                                                    <head>
                                                                                        ...
                                                                                        <link rel="stylesheet"
                                                                                            type="text/css"
                                                                                            href="${pageContext.request.contextPath}/assets/css/product_details.css" />
                                                                                    </head>

                                                                                    <body>

                                                                                        <jsp:include
                                                                                            page="/pages/shared/header.jsp" />
                                                                                                            ...
                                                                                                            <span
                                                                                                                ...
                                                                                                                <% if
                                                                                                                    ...
                                                                                                                    <% if
                                                                                                                        ...
                                                                                                                        <i
                                                                                                                            class="ph ph-tag"></i>
                                                                                                                        <%= activeDiscount.getDiscountValue()
                                                                                                                            %>
                                                                                                                            %
                                                                                                                            OFF
                                                                                                                            <% } else
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <% if
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <span
                                                                                                                        class="variant-label">Color</span>
                                                                                                                        ...
                                                                                                                        <% for
                                                                                                                            ...
                                                                                                                            <button
                                                                                                                                ...
                                                                                                                                <span
                                                                                                                                    ...
                                                                                                                                    style="background-color: <%= getColorCode(color) %>;"></span>
                                                                                                                                <%= color
                                                                                                                                    %>
                                                                                                                            </button>
                                                                                                                            <% }
                                                                                                                        ...
                                                                                                                        <% }
                                                                                                                            ...
                                                                                                                            <% if
                                                                                                                                ...
                                                                                                                                <div
                                                                                                                                    class="variant-option">
                                                                                                                                    <span
                                                                                                                                        class="variant-label">Power</span>
                                                                                                                                    <div class="variant-buttons"
                                                                                                                                        id="powerButtons">
                                                                                                                                        <% for
                                                                                                                                            (String
                                                                                                                        ...
                                                                                                                        <div
                                                                                                                            ...
                                                                                                                            <p>
                                                                                                                                <%= (purchaseLockMessage
                                                                                                                                    !=null
                                                                                                                                    &&
                                                                                                                                    !purchaseLockMessage.isEmpty())
                                                                                                                                    ?
                                                                                                                                    purchaseLockMessage
                                                                                                                                    : "Set your location to enable purchases."
                                                                                                                                    %>
                                                                                                                            </p>
                                                                                                                        </div>
                                                                                                                        <% }
                                                                                                                            ...
                                                                                                                            <div class="login-banner"
                                                                                                                                ...
                                                                                                                                style="display: none;">
                                                                                                                                <i
                                                                                                                                    class="ph ph-currency-circle-dollar"></i>
                                                                                                                                <p
                                                                                                                                    id="priceLimitMessage">
                                                                                                                                </p>
                                                                                                                            </div>
                                                                                                            </div>
                                                                                                ...
                                                                                                <div class="store-row">
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <div>
                                                                                                                ...
                                                                                                                <% if
                                                                                                                    ...
                                                                                                                    !=null
                                                                                                                    &&
                                                                                                                    !store.getStoreCity().isEmpty())
                                                                                                                    { %>
                                                                                                                    <span
                                                                                                                        class="store-contact-text">
                                                                                                                        <%= store.getStoreCity()
                                                                                                                            %>
                                                                                                                    </span>
                                                                                                                    <% }
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            class="info-card-header">
                                                                                                            <i
                                                                                                                class="ph ph-map-trifold"></i>
                                                                                                            Store
                                                                                                            Location
                                                                                                        </div>
                                                                                                        <% boolean
                                                                                                            hasStoreMapCoords=store.getLatitude()
                                                                                                            !=0.0 &&
                                                                                                            store.getLongitude()
                                                                                                            !=0.0; %>
                                                                                                            <% if
                                                                                                                ...
                                                                                                                <a href="https://maps.google.com/maps?daddr=<%= store.getLatitude() %>,<%= store.getLongitude() %>"
                                                                                                                    ...
                                                                                                                    class="navigate-btn">
                                                                                                                    <i
                                                                                                                        class="ph ph-navigation-arrow"></i>
                                                                                                                    Get
                                                                                                                    Directions
                                                                                                                </a>
                                                                                                                <% } else
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        ...
                                                                                                                        <i
                                                                                                                            class="ph ph-map-pin-simple-slash"></i>
                                                                                                                        <span>Store
                                                                                                                            location
                                                                                                                            not
                                                                                                                            configured</span>
                                                                                                ...
                                                                                                <% } %>
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <h3
                                                                                                            ...
                                                                                                            <i
                                                                                                                class="ph ph-star-half"></i>
                                                                                                            Customer
                                                                                                            Reviews</h3>

                                                                                                        <div
                                                                                                            class="rating-summary-card">
                                                                                                        ...
                                                                                                        <div
                                                                                                            id="reviewsList">
                                                                                                            <h4
                                                                                                                style="font-size: 1.2rem; font-weight: 600; margin-bottom: 20px;">
                                                                                                                All
                                                                                                                Reviews
                                                                                                            </h4>
...
<% } %>
                                                                                        ...
                                                                                        <% if (store !=null &&
                                                                                            store.getLatitude() !=0.0 &&
                                                                                            store.getLongitude() !=0.0)
                                                                                            { %>
                                                                                            <script
                                                                                                src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCO5jDKuyt8P6aVYy0RfIjanWVbHC--Ox0&callback=initStoreMap"
                                                                                                async defer></script>
                                                                                            <% } %>
                                                                                                <script
                                                                                                    src="${pageContext.request.contextPath}/assets/js/product_details.js"></script>
                                                                                                <script
                                                                                                    src="${pageContext.request.contextPath}/assets/js/product_reviews.js"></script>
